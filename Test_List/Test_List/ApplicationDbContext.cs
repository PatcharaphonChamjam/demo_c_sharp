...
namespace Test_List
{
...

    {
        ...
        {
            var adventure = new Genres() { Id = 4, Name = "Adventure" };
            var animation = new Genres() { Id = 5, Name = "Animation" };
            var drama = new Genres() { Id = 6, Name = "Drama" };
            var romance = new Genres() { Id = 7, Name = "Romance" };

            modelBuilder.Entity<Genres>()
                .HasData(new List<Genres>
                {
