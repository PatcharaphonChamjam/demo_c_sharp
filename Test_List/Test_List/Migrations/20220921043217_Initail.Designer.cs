...
namespace Test_List.Migrations
{
    ...
    [Migration("20220921043217_Initail")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Test_List.Entities.Genres", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Test_List.Entities.Movies", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Test_List.Entities.MoviesActors", b =>
                {
            ...
            modelBuilder.Entity("Test_List.Entities.MoviesGenres", b =>
                {
            ...
            modelBuilder.Entity("Test_List.Entities.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Test_List.Entities.MoviesActors", b =>
                {
                    b.HasOne("Test_List.Entities.Movies", "Movie")
                        .WithMany("MoviesActors")
                        .HasForeignKey("MovieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Test_List.Entities.Person", "Person")
                        .WithMany("MoviesActors")
            ...
            modelBuilder.Entity("Test_List.Entities.MoviesGenres", b =>
                {
                    b.HasOne("Test_List.Entities.Genres", "Genre")
